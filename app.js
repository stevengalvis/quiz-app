...
function submitAnswer(state,questionTemplate){
    $('.js-quiz-list').on(click,'.js-option',function(){
...
addQuestion(state,'Name of the planet Rick and Morty visit where the females have evolved to become super intelligent and rule the world?','Gazorpazorp',['Purge Planet','Gazorpazorp','Planet Squanch','Arbolez Mentirosos','Dimension C-137'],"In the episode \"Raising Gazorpazorp\" Rick, Summer, and Morty meet Gazorpians known for their large humanoid figures with six hands. Due to conflicts the male and female species of Gazorpazorp became divided. The females thrived and lead the world while the males remained primitive.",'images/gazorpazorp.png','images/gazorpazorp.gif');
//add scary terry
//add mr meeseks
